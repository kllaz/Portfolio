...
function simpleFirstButton() {
    document.getElementById('secondlink').style.textIndent = '0px';
    ...
    document.getElementById('thirdlink').style.textIndent = '0px';
...
function simpleSecondButton() {
    document.getElementById('firstlink').style.textIndent = '0px';
